...
//Java 8 version 도입 된 '함수형 프로그래밍'을 지원하기 위한 표현식
...
public class Main {
    public static void main(String[] args) {
        ...
        //Simplify your code
        //Enhance coding expression

        //**** Cons of using Lambda ****
        //Difficulty of Debugging
        //Improve reusability - 코드가 한줄이 아니고 여러줄로 늘어났을 때 결국 익명 클래스

        //**** 주요 함수형 인터페이스 - 메소드가 하나만 있는 인터페이스 ****

        //Supploier - T get();
        //매개변수 없이 값을 반환하는 인터페이스, 단순히 값을 '공급'하는 역할
        //Returning Interface without parameters, simply do a 'supply'
        ...
        //'하나의 매개변수'를 받아서 특정 조건을 검사한 후 true/false를 return
